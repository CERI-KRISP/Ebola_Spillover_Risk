...
dat <- read.csv("ebola_cleaned_occur_without_madagascar.csv")
...
# ============================================================
# 3. BUILD M REGION (accessible area for species)
# ============================================================
...
env <- rast("elevation_PhyloCov_srtm_to_2025_scale5000m.tif")

# CRITICAL: reproject M_vect to match raster CRS before crop/mask
# Mismatched CRS between vector and raster is a common cause of
# points appearing in wrong locations
...
set.seed(42)
n_pres  <- nrow(dat)   # 89
n_pa    <- n_pres * 2  # 178 target pseudo-absences
...
# ============================================================
# 6. FILTER: REMOVE POINTS WITHIN 100 KM OF ANY PRESENCE
# ============================================================
